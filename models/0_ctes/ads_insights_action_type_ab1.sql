...
-- depends_on: {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ads_insights_action_type') }}
select
...
from {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ads_insights_action_type') }} as table_alias
