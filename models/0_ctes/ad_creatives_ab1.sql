...
-- depends_on: {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ad_creatives') }}
select
...
from {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ad_creatives') }} as table_alias
-- ad_creatives
where 1 = 1
