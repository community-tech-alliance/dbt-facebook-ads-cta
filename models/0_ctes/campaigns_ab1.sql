...
-- depends_on: {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_campaigns') }}
select
...
from {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_campaigns') }} as table_alias
-- campaigns
where 1 = 1
