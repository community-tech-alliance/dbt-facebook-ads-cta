...
-- depends_on: {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ad_account') }}
select
...
from {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ad_account') }} as table_alias
-- ad_account
where 1 = 1
