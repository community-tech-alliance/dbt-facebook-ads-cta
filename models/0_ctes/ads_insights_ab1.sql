...
-- depends_on: {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ads_insights') }}
select
...
from {{ source('#PARTNER#_facebook_marketing_cta', '_airbyte_raw_ads_insights') }} as table_alias
-- ads_insights
where 1 = 1
